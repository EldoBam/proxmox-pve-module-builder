...
function Initialize-PVENodesQemuConfig {
    ...
    Process {
        ...
        if ($Tdf -and $Tdf -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Vcpus"="vcpus"; "MigrateDowntime"="migrate_downtime"; "Lock"="lock"; "Vga"="vga"; "Affinity"="affinity"; "Cipassword"="cipassword"; "Ostype"="ostype"; "Vmgenid"="vmgenid"; "Efidisk0"="efidisk0"; "Cpuunits"="cpuunits"; "Keyboard"="keyboard"; "Hotplug"="hotplug"; "Cpulimit"="cpulimit"; "Ciuser"="ciuser"; "Startup"="startup"; "Agent"="agent"; "Kvm"="kvm"; "Rng0"="rng0"; "Tpmstate0"="tpmstate0"; "Digest"="digest"; "Cicustom"="cicustom"; "AmdSev"="amd-sev"; "Smp"="smp"; "HostpciN"="hostpci[n]"; "Cpu"="cpu"; "ScsiN"="scsi[n]"; "Audio0"="audio0"; "Ciupgrade"="ciupgrade"; "Citype"="citype"; "Numa"="numa"; "Hookscript"="hookscript"; "Localtime"="localtime"; "Boot"="boot"; "Freeze"="freeze"; "Tablet"="tablet"; "Keephugepages"="keephugepages"; "VarArgs"="args"; "Description"="description"; "NumaN"="numa[n]"; "Vmstatestorage"="vmstatestorage"; "Scsihw"="scsihw"; "Protection"="protection"; "SerialN"="serial[n]"; "Watchdog"="watchdog"; "Startdate"="startdate"; "UsbN"="usb[n]"; "Reboot"="reboot"; "VirtioN"="virtio[n]"; "Balloon"="balloon"; "UnusedN"="unused[n]"; "MigrateSpeed"="migrate_speed"; "Name"="name"; "Bios"="bios"; "Onboot"="onboot"; "Hugepages"="hugepages"; "Bootdisk"="bootdisk"; "Smbios1"="smbios1"; "Arch"="arch"; "Cores"="cores"; "Shares"="shares"; "Sockets"="sockets"; "Autostart"="autostart"; "Acpi"="acpi"; "Searchdomain"="searchdomain"; "Sshkeys"="sshkeys"; "SataN"="sata[n]"; "Template"="template"; "Machine"="machine"; "SpiceEnhancements"="spice_enhancements"; "IdeN"="ide[n]"; "Tags"="tags"; "IpconfigN"="ipconfig[n]"; "Memory"="memory"; "Tdf"="tdf"; "NetN"="net[n]"; "Ivshmem"="ivshmem"; "Cdrom"="cdrom"; "ParallelN"="parallel[n]"; "Nameserver"="nameserver"
        }
...
function ConvertFrom-PVEJsonToNodesQemuConfig {
    ...
    Process {
        ...
        $AllProperties = ("vcpus", "migrate_downtime", "lock", "vga", "affinity", "cipassword", "ostype", "vmgenid", "efidisk0", "cpuunits", "keyboard", "hotplug", "cpulimit", "ciuser", "startup", "agent", "kvm", "rng0", "tpmstate0", "digest", "cicustom", "amd-sev", "smp", "hostpci[n]", "cpu", "scsi[n]", "audio0", "ciupgrade", "citype", "numa", "hookscript", "localtime", "boot", "freeze", "tablet", "keephugepages", "args", "description", "numa[n]", "vmstatestorage", "scsihw", "protection", "serial[n]", "watchdog", "startdate", "usb[n]", "reboot", "virtio[n]", "balloon", "unused[n]", "migrate_speed", "name", "bios", "onboot", "hugepages", "bootdisk", "smbios1", "arch", "cores", "shares", "sockets", "autostart", "acpi", "searchdomain", "sshkeys", "sata[n]", "template", "machine", "spice_enhancements", "ide[n]", "tags", "ipconfig[n]", "memory", "tdf", "net[n]", "ivshmem", "cdrom", "parallel[n]", "nameserver")
