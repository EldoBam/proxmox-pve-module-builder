...
function Initialize-PVENodesCephCfgDbInner {
    ...
    Process {
        ...
        if ($CanUpdateAtRuntime -and $CanUpdateAtRuntime -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"CanUpdateAtRuntime"="can_update_at_runtime"; "Level"="level"; "Section"="section"; "Mask"="mask"; "Value"="value"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToNodesCephCfgDbInner {
    ...
    Process {
        ...
        $AllProperties = ("can_update_at_runtime", "level", "section", "mask", "value", "name")
