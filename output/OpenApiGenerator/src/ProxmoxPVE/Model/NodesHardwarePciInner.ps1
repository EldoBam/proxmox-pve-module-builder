...
function Initialize-PVENodesHardwarePciInner {
    ...
    Process {
        ...
        if ($Mdev -and $Mdev -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Iommugroup"="iommugroup"; "SubsystemVendorName"="subsystem_vendor_name"; "SubsystemDeviceName"="subsystem_device_name"; "Device"="device"; "SubsystemDevice"="subsystem_device"; "Vendor"="vendor"; "Id"="id"; "Class"="class"; "SubsystemVendor"="subsystem_vendor"; "VendorName"="vendor_name"; "Mdev"="mdev"; "DeviceName"="device_name"
        }
...
function ConvertFrom-PVEJsonToNodesHardwarePciInner {
    ...
    Process {
        ...
        $AllProperties = ("iommugroup", "subsystem_vendor_name", "subsystem_device_name", "device", "subsystem_device", "vendor", "id", "class", "subsystem_vendor", "vendor_name", "mdev", "device_name")
