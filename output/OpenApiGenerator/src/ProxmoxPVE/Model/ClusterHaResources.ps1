...
function Initialize-PVEClusterHaResources {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"MaxRelocate"="max_relocate"; "Sid"="sid"; "State"="state"; "Digest"="digest"; "Type"="type"; "Group"="group"; "MaxRestart"="max_restart"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToClusterHaResources {
    ...
    Process {
        ...
        $AllProperties = ("max_relocate", "sid", "state", "digest", "type", "group", "max_restart", "comment")
