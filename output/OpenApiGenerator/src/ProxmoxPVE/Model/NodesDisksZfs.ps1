...
function Initialize-PVENodesDisksZfs {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"State"="state"; "Children"="children"; "Scan"="scan"; "Status"="status"; "Action"="action"; "Name"="name"; "Errors"="errors"
        }
...
function ConvertFrom-PVEJsonToNodesDisksZfs {
    ...
    Process {
        ...
        $AllProperties = ("state", "children", "scan", "status", "action", "name", "errors")
