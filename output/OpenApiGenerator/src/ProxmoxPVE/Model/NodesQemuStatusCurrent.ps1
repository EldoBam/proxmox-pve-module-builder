...
function Initialize-PVENodesQemuStatusCurrent {
    ...
    Process {
        ...
        if ($Template -and $Template -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Maxdisk"="maxdisk"; "RunningMachine"="running-machine"; "Diskread"="diskread"; "Ha"="ha"; "Netout"="netout"; "Spice"="spice"; "Status"="status"; "Cpus"="cpus"; "Vmid"="vmid"; "Maxmem"="maxmem"; "Qmpstatus"="qmpstatus"; "Clipboard"="clipboard"; "RunningQemu"="running-qemu"; "Agent"="agent"; "Lock"="lock"; "Name"="name"; "VarPid"="pid"; "Template"="template"; "Tags"="tags"; "Diskwrite"="diskwrite"; "Uptime"="uptime"; "Netin"="netin"
        }
...
function ConvertFrom-PVEJsonToNodesQemuStatusCurrent {
    ...
    Process {
        ...
        $AllProperties = ("maxdisk", "running-machine", "diskread", "ha", "netout", "spice", "status", "cpus", "vmid", "maxmem", "qmpstatus", "clipboard", "running-qemu", "agent", "lock", "name", "pid", "template", "tags", "diskwrite", "uptime", "netin")
