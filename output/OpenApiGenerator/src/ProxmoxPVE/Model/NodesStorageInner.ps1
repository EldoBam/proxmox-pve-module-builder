...
function Initialize-PVENodesStorageInner {
    ...
    Process {
        ...
        if ($Active -and $Active -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Avail"="avail"; "Used"="used"; "Type"="type"; "Enabled"="enabled"; "Total"="total"; "Shared"="shared"; "UsedFraction"="used_fraction"; "Content"="content"; "Storage"="storage"; "Active"="active"
        }
...
function ConvertFrom-PVEJsonToNodesStorageInner {
    ...
    Process {
        ...
        $AllProperties = ("avail", "used", "type", "enabled", "total", "shared", "used_fraction", "content", "storage", "active")
