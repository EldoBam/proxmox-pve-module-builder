...
function Initialize-PVENodesLxcConfig {
    ...
    Process {
        ...
        if ($Template -and $Template -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Hostname"="hostname"; "Description"="description"; "Startup"="startup"; "Timezone"="timezone"; "DevN"="dev[n]"; "Onboot"="onboot"; "Swap"="swap"; "Digest"="digest"; "Ostype"="ostype"; "Protection"="protection"; "Nameserver"="nameserver"; "Cpuunits"="cpuunits"; "Lock"="lock"; "Cpulimit"="cpulimit"; "Tags"="tags"; "UnusedN"="unused[n]"; "Unprivileged"="unprivileged"; "Rootfs"="rootfs"; "Tty"="tty"; "NetN"="net[n]"; "Features"="features"; "Cmode"="cmode"; "MpN"="mp[n]"; "Searchdomain"="searchdomain"; "Debug"="debug"; "Hookscript"="hookscript"; "Console"="console"; "Lxc"="lxc"; "Arch"="arch"; "Cores"="cores"; "Memory"="memory"; "Template"="template"
        }
...
function ConvertFrom-PVEJsonToNodesLxcConfig {
    ...
    Process {
        ...
        $AllProperties = ("hostname", "description", "startup", "timezone", "dev[n]", "onboot", "swap", "digest", "ostype", "protection", "nameserver", "cpuunits", "lock", "cpulimit", "tags", "unused[n]", "unprivileged", "rootfs", "tty", "net[n]", "features", "cmode", "mp[n]", "searchdomain", "debug", "hookscript", "console", "lxc", "arch", "cores", "memory", "template")
