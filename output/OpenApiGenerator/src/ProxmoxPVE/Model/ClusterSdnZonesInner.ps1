...
function Initialize-PVEClusterSdnZonesInner {
    ...
    Process {
        ...
        if ($Pending -and $Pending -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Dns"="dns"; "Nodes"="nodes"; "Reversedns"="reversedns"; "Zone"="zone"; "State"="state"; "Ipam"="ipam"; "Dnszone"="dnszone"; "Type"="type"; "Pending"="pending"; "Dhcp"="dhcp"; "Mtu"="mtu"
        }
...
function ConvertFrom-PVEJsonToClusterSdnZonesInner {
    ...
    Process {
        ...
        $AllProperties = ("dns", "nodes", "reversedns", "zone", "state", "ipam", "dnszone", "type", "pending", "dhcp", "mtu")
