...
function Initialize-PVEClusterNotificationsEndpointsWebhook {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Secret"="secret"; "Body"="body"; "Disable"="disable"; "Comment"="comment"; "Digest"="digest"; "Method"="method"; "Url"="url"; "Name"="name"; "Header"="header"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsWebhook {
    ...
    Process {
        ...
        $AllProperties = ("secret", "body", "disable", "comment", "digest", "method", "url", "name", "header")
