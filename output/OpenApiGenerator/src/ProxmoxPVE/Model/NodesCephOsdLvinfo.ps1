...
function Initialize-PVENodesCephOsdLvinfo {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"VgName"="vg_name"; "LvUuid"="lv_uuid"; "LvName"="lv_name"; "LvSize"="lv_size"; "CreationTime"="creation_time"; "LvPath"="lv_path"
        }
...
function ConvertFrom-PVEJsonToNodesCephOsdLvinfo {
    ...
    Process {
        ...
        $AllProperties = ("vg_name", "lv_uuid", "lv_name", "lv_size", "creation_time", "lv_path")
