...
function Initialize-PVEClusterHaStatusCurrentInner {
    ...
    Process {
        ...
        if ($Quorate -and $Quorate -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Status"="status"; "Timestamp"="timestamp"; "MaxRelocate"="max_relocate"; "Sid"="sid"; "RequestState"="request_state"; "Id"="id"; "Type"="type"; "Quorate"="quorate"; "CrmState"="crm_state"; "MaxRestart"="max_restart"; "State"="state"; "Node"="node"
        }
...
function ConvertFrom-PVEJsonToClusterHaStatusCurrentInner {
    ...
    Process {
        ...
        $AllProperties = ("status", "timestamp", "max_relocate", "sid", "request_state", "id", "type", "quorate", "crm_state", "max_restart", "state", "node")
