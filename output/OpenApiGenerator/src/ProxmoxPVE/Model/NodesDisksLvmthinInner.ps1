...
function Initialize-PVENodesDisksLvmthinInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Used"="used"; "Lv"="lv"; "MetadataUsed"="metadata_used"; "MetadataSize"="metadata_size"; "Vg"="vg"; "LvSize"="lv_size"
        }
...
function ConvertFrom-PVEJsonToNodesDisksLvmthinInner {
    ...
    Process {
        ...
        $AllProperties = ("used", "lv", "metadata_used", "metadata_size", "vg", "lv_size")
