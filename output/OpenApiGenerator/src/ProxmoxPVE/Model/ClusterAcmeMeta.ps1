...
function Initialize-PVEClusterAcmeMeta {
    ...
    Process {
        ...
        if ($ExternalAccountRequired -and $ExternalAccountRequired -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"CaaIdentities"="caaIdentities"; "Website"="website"; "TermsOfService"="termsOfService"; "ExternalAccountRequired"="externalAccountRequired"
        }
...
function ConvertFrom-PVEJsonToClusterAcmeMeta {
    ...
    Process {
        ...
        $AllProperties = ("caaIdentities", "website", "termsOfService", "externalAccountRequired")
