...
function Initialize-PVENodesQemuInner {
    ...
    Process {
        ...
        if ($Template -and $Template -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Maxdisk"="maxdisk"; "RunningMachine"="running-machine"; "Diskread"="diskread"; "Netout"="netout"; "Cpus"="cpus"; "Vmid"="vmid"; "Maxmem"="maxmem"; "Qmpstatus"="qmpstatus"; "Status"="status"; "RunningQemu"="running-qemu"; "Lock"="lock"; "Name"="name"; "VarPid"="pid"; "Template"="template"; "Tags"="tags"; "Diskwrite"="diskwrite"; "Uptime"="uptime"; "Netin"="netin"
        }
...
function ConvertFrom-PVEJsonToNodesQemuInner {
    ...
    Process {
        ...
        $AllProperties = ("maxdisk", "running-machine", "diskread", "netout", "cpus", "vmid", "maxmem", "qmpstatus", "status", "running-qemu", "lock", "name", "pid", "template", "tags", "diskwrite", "uptime", "netin")
