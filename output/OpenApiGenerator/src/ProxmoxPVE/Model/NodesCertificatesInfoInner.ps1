...
function Initialize-PVENodesCertificatesInfoInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Fingerprint"="fingerprint"; "Pem"="pem"; "San"="san"; "PublicKeyType"="public-key-type"; "Notafter"="notafter"; "Filename"="filename"; "PublicKeyBits"="public-key-bits"; "Notbefore"="notbefore"; "Subject"="subject"; "Issuer"="issuer"
        }
...
function ConvertFrom-PVEJsonToNodesCertificatesInfoInner {
    ...
    Process {
        ...
        $AllProperties = ("fingerprint", "pem", "san", "public-key-type", "notafter", "filename", "public-key-bits", "notbefore", "subject", "issuer")
