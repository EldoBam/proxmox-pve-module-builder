...
function Initialize-PVEClusterStatusInner {
    ...
    Process {
        ...
        if ($Online -and $Online -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"VarLocal"="local"; "Nodes"="nodes"; "Version"="version"; "Level"="level"; "Type"="type"; "Nodeid"="nodeid"; "Id"="id"; "Quorate"="quorate"; "Online"="online"; "Name"="name"; "Ip"="ip"
        }
...
function ConvertFrom-PVEJsonToClusterStatusInner {
    ...
    Process {
        ...
        $AllProperties = ("local", "nodes", "version", "level", "type", "nodeid", "id", "quorate", "online", "name", "ip")
