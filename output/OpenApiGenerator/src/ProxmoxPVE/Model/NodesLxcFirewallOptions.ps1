...
function Initialize-PVENodesLxcFirewallOptions {
    ...
    Process {
        ...
        if ($Ndp -and $Ndp -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Macfilter"="macfilter"; "Enable"="enable"; "LogLevelOut"="log_level_out"; "LogLevelIn"="log_level_in"; "Radv"="radv"; "PolicyIn"="policy_in"; "Ipfilter"="ipfilter"; "Dhcp"="dhcp"; "PolicyOut"="policy_out"; "Ndp"="ndp"
        }
...
function ConvertFrom-PVEJsonToNodesLxcFirewallOptions {
    ...
    Process {
        ...
        $AllProperties = ("macfilter", "enable", "log_level_out", "log_level_in", "radv", "policy_in", "ipfilter", "dhcp", "policy_out", "ndp")
