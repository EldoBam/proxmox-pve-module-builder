...
function Initialize-PVEClusterNotificationsEndpointsSendmail {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"MailtoUser"="mailto-user"; "Author"="author"; "Disable"="disable"; "FromAddress"="from-address"; "Digest"="digest"; "Mailto"="mailto"; "Name"="name"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSendmail {
    ...
    Process {
        ...
        $AllProperties = ("mailto-user", "author", "disable", "from-address", "digest", "mailto", "name", "comment")
