...
function Initialize-PVEAccessUsers {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 2048) {
		 ...
		 $DisplayNameMapping =@{
			"Email"="email"; "Firstname"="firstname"; "Groups"="groups"; "Tokens"="tokens"; "Keys"="keys"; "Lastname"="lastname"; "Enable"="enable"; "Expire"="expire"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToAccessUsers {
    ...
    Process {
        ...
        $AllProperties = ("email", "firstname", "groups", "tokens", "keys", "lastname", "enable", "expire", "comment")
