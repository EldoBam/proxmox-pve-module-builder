...
function Initialize-PVENodesTasksStatus {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"User"="user"; "VarPid"="pid"; "Type"="type"; "Exitstatus"="exitstatus"; "Id"="id"; "Status"="status"; "Starttime"="starttime"; "Upid"="upid"; "Pstart"="pstart"; "Node"="node"
        }
...
function ConvertFrom-PVEJsonToNodesTasksStatus {
    ...
    Process {
        ...
        $AllProperties = ("user", "pid", "type", "exitstatus", "id", "status", "starttime", "upid", "pstart", "node")
