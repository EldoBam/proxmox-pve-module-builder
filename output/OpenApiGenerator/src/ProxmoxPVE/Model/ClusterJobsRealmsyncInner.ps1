...
function Initialize-PVEClusterJobsRealmsyncInner {
    ...
    Process {
        ...
        if (!$Realm -and $Realm.length -gt 32) {
		 ...
		 $DisplayNameMapping =@{
			"Schedule"="schedule"; "LastRun"="last-run"; "Id"="id"; "Scope"="scope"; "Enabled"="enabled"; "Realm"="realm"; "NextRun"="next-run"; "Comment"="comment"; "RemoveVanished"="remove-vanished"
        }
...
function ConvertFrom-PVEJsonToClusterJobsRealmsyncInner {
    ...
    Process {
        ...
        $AllProperties = ("schedule", "last-run", "id", "scope", "enabled", "realm", "next-run", "comment", "remove-vanished")
