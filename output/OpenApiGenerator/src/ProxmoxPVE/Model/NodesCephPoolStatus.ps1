...
function Initialize-PVENodesCephPoolStatus {
    ...
    Process {
        ...
        if ($PgNumMin -and $PgNumMin -gt 32768) {
		 ...
		 $DisplayNameMapping =@{
			"PgAutoscaleMode"="pg_autoscale_mode"; "Size"="size"; "TargetSize"="target_size"; "Nodelete"="nodelete"; "Noscrub"="noscrub"; "ApplicationList"="application_list"; "NodeepScrub"="nodeep-scrub"; "Id"="id"; "Application"="application"; "CrushRule"="crush_rule"; "AutoscaleStatus"="autoscale_status"; "TargetSizeRatio"="target_size_ratio"; "UseGmtHitset"="use_gmt_hitset"; "Nopgchange"="nopgchange"; "PgpNum"="pgp_num"; "Name"="name"; "PgNum"="pg_num"; "Statistics"="statistics"; "FastRead"="fast_read"; "Hashpspool"="hashpspool"; "Nosizechange"="nosizechange"; "MinSize"="min_size"; "WriteFadviseDontneed"="write_fadvise_dontneed"; "PgNumMin"="pg_num_min"
        }
...
function ConvertFrom-PVEJsonToNodesCephPoolStatus {
    ...
    Process {
        ...
        $AllProperties = ("pg_autoscale_mode", "size", "target_size", "nodelete", "noscrub", "application_list", "nodeep-scrub", "id", "application", "crush_rule", "autoscale_status", "target_size_ratio", "use_gmt_hitset", "nopgchange", "pgp_num", "name", "pg_num", "statistics", "fast_read", "hashpspool", "nosizechange", "min_size", "write_fadvise_dontneed", "pg_num_min")
