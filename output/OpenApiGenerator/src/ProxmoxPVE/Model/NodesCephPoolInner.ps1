...
function Initialize-PVENodesCephPoolInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"PgAutoscaleMode"="pg_autoscale_mode"; "PoolName"="pool_name"; "TargetSize"="target_size"; "ApplicationMetadata"="application_metadata"; "CrushRule"="crush_rule"; "AutoscaleStatus"="autoscale_status"; "CrushRuleName"="crush_rule_name"; "PgNum"="pg_num"; "Type"="type"; "TargetSizeRatio"="target_size_ratio"; "MinSize"="min_size"; "BytesUsed"="bytes_used"; "Size"="size"; "PgNumFinal"="pg_num_final"; "Pool"="pool"; "PercentUsed"="percent_used"; "PgNumMin"="pg_num_min"
        }
...
function ConvertFrom-PVEJsonToNodesCephPoolInner {
    ...
    Process {
        ...
        $AllProperties = ("pg_autoscale_mode", "pool_name", "target_size", "application_metadata", "crush_rule", "autoscale_status", "crush_rule_name", "pg_num", "type", "target_size_ratio", "min_size", "bytes_used", "size", "pg_num_final", "pool", "percent_used", "pg_num_min")
