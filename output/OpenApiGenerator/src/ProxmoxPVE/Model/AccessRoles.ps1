...
function Initialize-PVEAccessRoles {
    ...
    Process {
        ...
        if ($GroupAllocate -and $GroupAllocate -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"VMConfigDisk"="VM.Config.Disk"; "VMPowerMgmt"="VM.PowerMgmt"; "VMMigrate"="VM.Migrate"; "MappingModify"="Mapping.Modify"; "VMConfigHWType"="VM.Config.HWType"; "VMSnapshotRollback"="VM.Snapshot.Rollback"; "MappingAudit"="Mapping.Audit"; "RealmAllocate"="Realm.Allocate"; "SysPowerMgmt"="Sys.PowerMgmt"; "SysConsole"="Sys.Console"; "SysSyslog"="Sys.Syslog"; "MappingUse"="Mapping.Use"; "VMAudit"="VM.Audit"; "SDNUse"="SDN.Use"; "SysIncoming"="Sys.Incoming"; "VMConsole"="VM.Console"; "UserModify"="User.Modify"; "VMAllocate"="VM.Allocate"; "DatastoreAllocateSpace"="Datastore.AllocateSpace"; "SysAccessNetwork"="Sys.AccessNetwork"; "VMBackup"="VM.Backup"; "PoolAudit"="Pool.Audit"; "DatastoreAllocate"="Datastore.Allocate"; "SDNAudit"="SDN.Audit"; "SysAudit"="Sys.Audit"; "VMConfigMemory"="VM.Config.Memory"; "VMConfigCloudinit"="VM.Config.Cloudinit"; "PoolAllocate"="Pool.Allocate"; "DatastoreAllocateTemplate"="Datastore.AllocateTemplate"; "RealmAllocateUser"="Realm.AllocateUser"; "VMSnapshot"="VM.Snapshot"; "DatastoreAudit"="Datastore.Audit"; "VMConfigNetwork"="VM.Config.Network"; "VMClone"="VM.Clone"; "VMConfigCPU"="VM.Config.CPU"; "VMConfigCDROM"="VM.Config.CDROM"; "VMMonitor"="VM.Monitor"; "SysModify"="Sys.Modify"; "VMConfigOptions"="VM.Config.Options"; "SDNAllocate"="SDN.Allocate"; "PermissionsModify"="Permissions.Modify"; "GroupAllocate"="Group.Allocate"
        }
...
function ConvertFrom-PVEJsonToAccessRoles {
    ...
    Process {
        ...
        $AllProperties = ("VM.Config.Disk", "VM.PowerMgmt", "VM.Migrate", "Mapping.Modify", "VM.Config.HWType", "VM.Snapshot.Rollback", "Mapping.Audit", "Realm.Allocate", "Sys.PowerMgmt", "Sys.Console", "Sys.Syslog", "Mapping.Use", "VM.Audit", "SDN.Use", "Sys.Incoming", "VM.Console", "User.Modify", "VM.Allocate", "Datastore.AllocateSpace", "Sys.AccessNetwork", "VM.Backup", "Pool.Audit", "Datastore.Allocate", "SDN.Audit", "Sys.Audit", "VM.Config.Memory", "VM.Config.Cloudinit", "Pool.Allocate", "Datastore.AllocateTemplate", "Realm.AllocateUser", "VM.Snapshot", "Datastore.Audit", "VM.Config.Network", "VM.Clone", "VM.Config.CPU", "VM.Config.CDROM", "VM.Monitor", "Sys.Modify", "VM.Config.Options", "SDN.Allocate", "Permissions.Modify", "Group.Allocate")
