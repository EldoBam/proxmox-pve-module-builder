...
function Initialize-PVEClusterResourcesInner {
    ...
    Process {
        ...
        if ($Template -and $Template -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Storage"="storage"; "Content"="content"; "Cpu"="cpu"; "Type"="type"; "Diskread"="diskread"; "CgroupMode"="cgroup-mode"; "Hastate"="hastate"; "Disk"="disk"; "Vmid"="vmid"; "Lock"="lock"; "Netout"="netout"; "Tags"="tags"; "Id"="id"; "Level"="level"; "Name"="name"; "Pool"="pool"; "Maxcpu"="maxcpu"; "Mem"="mem"; "Maxdisk"="maxdisk"; "Plugintype"="plugintype"; "Template"="template"; "Diskwrite"="diskwrite"; "Maxmem"="maxmem"; "Status"="status"; "Uptime"="uptime"; "Netin"="netin"; "Node"="node"
        }
...
function ConvertFrom-PVEJsonToClusterResourcesInner {
    ...
    Process {
        ...
        $AllProperties = ("storage", "content", "cpu", "type", "diskread", "cgroup-mode", "hastate", "disk", "vmid", "lock", "netout", "tags", "id", "level", "name", "pool", "maxcpu", "mem", "maxdisk", "plugintype", "template", "diskwrite", "maxmem", "status", "uptime", "netin", "node")
