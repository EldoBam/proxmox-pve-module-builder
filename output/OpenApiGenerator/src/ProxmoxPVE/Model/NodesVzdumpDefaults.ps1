...
function Initialize-PVENodesVzdumpDefaults {
    ...
    Process {
        ...
        if ($Stdexcludes -and $Stdexcludes -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Mailnotification"="mailnotification"; "Storage"="storage"; "Fleecing"="fleecing"; "PruneBackups"="prune-backups"; "Zstd"="zstd"; "Bwlimit"="bwlimit"; "Quiet"="quiet"; "Stop"="stop"; "Mode"="mode"; "NotificationMode"="notification-mode"; "Mailto"="mailto"; "Stopwait"="stopwait"; "NotificationTarget"="notification-target"; "Protected"="protected"; "Vmid"="vmid"; "Script"="script"; "All"="all"; "Maxfiles"="maxfiles"; "Performance"="performance"; "Dumpdir"="dumpdir"; "Pigz"="pigz"; "NotesTemplate"="notes-template"; "ExcludePath"="exclude-path"; "Pool"="pool"; "Compress"="compress"; "Lockwait"="lockwait"; "NotificationPolicy"="notification-policy"; "Remove"="remove"; "Ionice"="ionice"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "Tmpdir"="tmpdir"; "Node"="node"; "Stdexcludes"="stdexcludes"; "Exclude"="exclude"
        }
...
function ConvertFrom-PVEJsonToNodesVzdumpDefaults {
    ...
    Process {
        ...
        $AllProperties = ("mailnotification", "storage", "fleecing", "prune-backups", "zstd", "bwlimit", "quiet", "stop", "mode", "notification-mode", "mailto", "stopwait", "notification-target", "protected", "vmid", "script", "all", "maxfiles", "performance", "dumpdir", "pigz", "notes-template", "exclude-path", "pool", "compress", "lockwait", "notification-policy", "remove", "ionice", "pbs-change-detection-mode", "tmpdir", "node", "stdexcludes", "exclude")
