...
function Initialize-PVENodesDisksListInner {
    ...
    Process {
        ...
        if ($Gpt -and $Gpt -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Vendor"="vendor"; "Size"="size"; "Mounted"="mounted"; "Health"="health"; "Used"="used"; "Model"="model"; "Osdid"="osdid"; "Devpath"="devpath"; "Gpt"="gpt"; "Parent"="parent"; "Wwn"="wwn"; "OsdidList"="osdid-list"; "Serial"="serial"
        }
...
function ConvertFrom-PVEJsonToNodesDisksListInner {
    ...
    Process {
        ...
        $AllProperties = ("vendor", "size", "mounted", "health", "used", "model", "osdid", "devpath", "gpt", "parent", "wwn", "osdid-list", "serial")
