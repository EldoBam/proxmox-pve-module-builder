...
function Initialize-PVENodesInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"SslFingerprint"="ssl_fingerprint"; "Cpu"="cpu"; "Maxmem"="maxmem"; "Level"="level"; "Uptime"="uptime"; "Mem"="mem"; "Maxcpu"="maxcpu"; "Status"="status"; "Node"="node"
        }
...
function ConvertFrom-PVEJsonToNodesInner {
    ...
    Process {
        ...
        $AllProperties = ("ssl_fingerprint", "cpu", "maxmem", "level", "uptime", "mem", "maxcpu", "status", "node")
