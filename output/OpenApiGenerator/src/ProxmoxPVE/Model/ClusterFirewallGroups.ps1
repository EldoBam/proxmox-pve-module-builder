...
ClusterFirewallGroups<PSCustomObject>
#>

function Initialize-PVEClusterFirewallGroups {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEClusterFirewallGroups' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug


		 $DisplayNameMapping =@{
			"Log"="log"; "Pos"="pos"; "Ipversion"="ipversion"; "Type"="type"; "Macro"="macro"; "IcmpType"="icmp-type"; "Sport"="sport"; "Iface"="iface"; "Source"="source"; "Dport"="dport"; "Dest"="dest"; "Enable"="enable"; "Comment"="comment"; "Proto"="proto"; "Action"="action"
        }
...
Convert from JSON to ClusterFirewallGroups<PSCustomObject>
...
ClusterFirewallGroups<PSCustomObject>
#>
function ConvertFrom-PVEJsonToClusterFirewallGroups {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEClusterFirewallGroups' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEClusterFirewallGroups
        $AllProperties = ("log", "pos", "ipversion", "type", "macro", "icmp-type", "sport", "iface", "source", "dport", "dest", "enable", "comment", "proto", "action")
