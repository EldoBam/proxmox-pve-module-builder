...
function Initialize-PVENodesConfig {
    ...
    Process {
        ...
        if (!$Description -and $Description.length -gt 65536) {
		 ...
		 $DisplayNameMapping =@{
			"Wakeonlan"="wakeonlan"; "StartallOnbootDelay"="startall-onboot-delay"; "Digest"="digest"; "Description"="description"; "AcmedomainN"="acmedomain[n]"; "Acme"="acme"
        }
...
function ConvertFrom-PVEJsonToNodesConfig {
    ...
    Process {
        ...
        $AllProperties = ("wakeonlan", "startall-onboot-delay", "digest", "description", "acmedomain[n]", "acme")
