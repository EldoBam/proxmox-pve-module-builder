...
function Initialize-PVENodesFirewallOptions {
    ...
    Process {
        ...
        if ($Enable -and $Enable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"ProtectionSynfloodBurst"="protection_synflood_burst"; "NfConntrackAllowInvalid"="nf_conntrack_allow_invalid"; "Nftables"="nftables"; "LogLevelOut"="log_level_out"; "Ndp"="ndp"; "NfConntrackTcpTimeoutEstablished"="nf_conntrack_tcp_timeout_established"; "Tcpflags"="tcpflags"; "NfConntrackMax"="nf_conntrack_max"; "ProtectionSynflood"="protection_synflood"; "LogNfConntrack"="log_nf_conntrack"; "LogLevelIn"="log_level_in"; "TcpFlagsLogLevel"="tcp_flags_log_level"; "NfConntrackHelpers"="nf_conntrack_helpers"; "LogLevelForward"="log_level_forward"; "Nosmurfs"="nosmurfs"; "NfConntrackTcpTimeoutSynRecv"="nf_conntrack_tcp_timeout_syn_recv"; "SmurfLogLevel"="smurf_log_level"; "ProtectionSynfloodRate"="protection_synflood_rate"; "Enable"="enable"
        }
...
function ConvertFrom-PVEJsonToNodesFirewallOptions {
    ...
    Process {
        ...
        $AllProperties = ("protection_synflood_burst", "nf_conntrack_allow_invalid", "nftables", "log_level_out", "ndp", "nf_conntrack_tcp_timeout_established", "tcpflags", "nf_conntrack_max", "protection_synflood", "log_nf_conntrack", "log_level_in", "tcp_flags_log_level", "nf_conntrack_helpers", "log_level_forward", "nosmurfs", "nf_conntrack_tcp_timeout_syn_recv", "smurf_log_level", "protection_synflood_rate", "enable")
