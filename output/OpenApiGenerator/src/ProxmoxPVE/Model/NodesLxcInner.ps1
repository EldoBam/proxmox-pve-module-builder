...
function Initialize-PVENodesLxcInner {
    ...
    Process {
        ...
        if ($Template -and $Template -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Maxdisk"="maxdisk"; "Diskread"="diskread"; "Netout"="netout"; "Cpus"="cpus"; "Vmid"="vmid"; "Maxmem"="maxmem"; "Tags"="tags"; "Status"="status"; "Lock"="lock"; "Name"="name"; "Template"="template"; "Maxswap"="maxswap"; "Disk"="disk"; "Diskwrite"="diskwrite"; "Uptime"="uptime"; "Netin"="netin"
        }
...
function ConvertFrom-PVEJsonToNodesLxcInner {
    ...
    Process {
        ...
        $AllProperties = ("maxdisk", "diskread", "netout", "cpus", "vmid", "maxmem", "tags", "status", "lock", "name", "template", "maxswap", "disk", "diskwrite", "uptime", "netin")
