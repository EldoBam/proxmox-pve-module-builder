...
function Initialize-PVENodesCephMonInner {
    ...
    Process {
        ...
        if ($Quorum -and $Quorum -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"CephVersionShort"="ceph_version_short"; "CephVersion"="ceph_version"; "Addr"="addr"; "State"="state"; "Service"="service"; "VarHost"="host"; "Rank"="rank"; "Quorum"="quorum"; "Direxists"="direxists"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToNodesCephMonInner {
    ...
    Process {
        ...
        $AllProperties = ("ceph_version_short", "ceph_version", "addr", "state", "service", "host", "rank", "quorum", "direxists", "name")
